...
Version **0.1.22** ranks one 20-hour transmute above repeatable crafts when that craft is profitable. The 450 profession target is the destination. The plan uses the live skill. A recipe above that skill is not the next row.
